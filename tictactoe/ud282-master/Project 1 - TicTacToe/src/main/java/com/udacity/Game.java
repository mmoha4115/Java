...
public class Game {
    ...
    public boolean checkRows(char [][]grid,char mark){
        if (grid[0][0] == mark && grid[0][1] == mark && grid[0][2]== mark){
            return true;
        }else  if (grid[1][0] == mark && grid[1][1] == mark && grid[1][2]== mark){
            return true;
    }else  if (grid[2][0] == mark && grid[2][1] == mark && grid[2][2]== mark) {
            return true;
        }else { return false;}
    }

    public boolean checkColums(char [][]grid,char mark){
        if (grid[0][0] == mark && grid[1][0] == mark && grid[2][0]== mark){
            return true;
        }else  if (grid[0][1] == mark && grid[1][1] == mark && grid[2][1]== mark){
            return true;
    ...
    public boolean checkHorizontals(char [][]grid,char mark){
        if (grid[0][0] == mark && grid[1][1] == mark && grid[2][2]== mark){
            return true;
        }else  if (grid[0][2] == mark && grid[1][1] == mark && grid[2][0]== mark){
            return true;
        }else { return false;}
    }
    ...
    public String checkGameWinner(char [][]grid) {
        ...
        if (checkRows(grid, markX) || checkColums(grid,markX) || checkHorizontals(grid,markX)) {
            System.out.println("MarkO");
            result = "X wins";
            return result;
        } else if (checkRows(grid, markO) || checkColums(grid,markO) || checkHorizontals(grid,markO)) {
            System.out.println("MarkO");
            result = "O wins";
            return result;
            ...
            count = count + 1;
            System.out.println(count+"this is coun and ");
            return result;
        }
    }
